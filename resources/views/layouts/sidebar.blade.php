<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <!-- <a class="navbar-brand m-0" href="logo.png" target="_blank"> -->
            <img src="logo.png"  alt="main_logo" id="logo" height="112px" width="234px">
...
<style>
     /* .bg-gradient-dark {
        background-image: linear-gradient(195deg, #F3FBFF 0%, #F3FBFF 100%) !important;
    }
    ...
    .bg-gradient-primary {
    background-image: linear-gradient(195deg, #192354 0%, #192354 100%);
} */
    /* #logo {
    width: 234px !important;
    height: 500px !important;
