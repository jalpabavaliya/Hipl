...
<div class="row bg-light vh-100">
    ...
    <div class="col-xxl-10" id="ajaxModelexa" aria-hidden="true">
        <div class="w3-panel w3-card card ">
            <div id="white">
                <form method="post" id="docForm" name="docForm" action="{{ url('/documents/update') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="Neon Neon-theme-dragdropbox">
                                ...
                                <div class="Neon-input-dragDrop">
                                    <div class="Neon-input-inner">
                                        ...
                                        <img class="bd-placeholder-img" src="{{ url('adhar_card/'.$a->adhar_card) }}"  width='100%' style="height:100px;">
                            ...
                            <div class="Neon Neon-theme-dragdropbox">
                                ...
                                <div class="Neon-input-dragDrop">
                                    <div class="Neon-input-inner">
                                        ...
                                        <img class="bd-placeholder-img" src="{{ url('pan_card/'.$a->pan_card) }}"  width='100%' style="height:100px;">
                            ...
                            <div class="Neon Neon-theme-dragdropbox">
                                ...
                                <div class="Neon-input-dragDrop">
                                    <div class="Neon-input-inner">
                                        ...
                                        <img class="bd-placeholder-img" src="{{ url('voter_card/'.$a->voter_card) }}"  width='100%' style="height:100px;">
                            ...
                            <div class="Neon Neon-theme-dragdropbox">
                                ...
                                <div class="Neon-input-dragDrop">
                                    <div class="Neon-input-inner">
                                        ...
                                        <img class="bd-placeholder-img" src="{{ url('standard_10_markshhet/'.$a->standard_10_markshhet) }}"  width='100%' style="height:100px;">
                            ...
                            <div class="Neon Neon-theme-dragdropbox">
                                ...
                                <div class="Neon-input-dragDrop">
                                    <div class="Neon-input-inner">
                                        ...
                                        <img class="bd-placeholder-img" src="{{ url('standard_12_markshhet/'.$a->standard_12_markshhet) }}" width='100%' style="height:100px;">
